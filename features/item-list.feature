...
When I click the Buy button next to the item with ID "12"

Then I should see that the item with an ID of "12" has "6" inventory

@ac4
Scenario: Updating inventory
When I click the Sell button next to the item with ID "12"
...
When I click the Delete button next to the item with ID "12"

Then I should see that the item list does not contain an item with ID "12"
